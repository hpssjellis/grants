...
|  MS#10    Summer 2022         |       Send PR requests to the the Helium docs to inform a wider Helium audience of using the Arduino Portenta                                           |     Note Yet Started [helium/docs](https://github.com/helium/docs)        |     $500 USD          |
...
|  MS#12     Summer 2022         |         Create a Github summary of all facets of Learning microcontroller sensors, actuators, machine Learning and how to send the information to the Helium Network      |     On Going [Maker100 Course](https://github.com/hpssjellis/maker100)     |    $500 USD       |
