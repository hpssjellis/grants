...
|  MS#5    Fall 2021         |        Create several examples of sending data on the Helium network                                             |     On Going [ Code here](https://github.com/hpssjellis/portenta-pro-community-solutions/blob/main/examples/c-portenta-vision-shields/c-b-lorawan-specific/)        |     $1000 USD          |
|  MS#5    Fall 2021         |        Create Videos of the above example code                                             |     On Going [ Code here](https://github.com/hpssjellis/portenta-pro-community-solutions/blob/main/examples/c-portenta-vision-shields/c-b-lorawan-specific/)        |     $1000 USD          |
...
|  MS#5    Spring 2022         |        Create a Hackster.io example of the above code, videos and Helium sensor solutions, (Possibly publish to other social media learning sites)                                             |     Note Yet Started [my Hackster.io area](https://www.hackster.io/jeremy-ellis/)        |     $1000 USD          |
|  MS#5    Spring 2022         |       Send PR requests to the relevant Arduino libraries to have my Helium examples on the Arduino MBED core                                            |     Note Yet Started [ArduinoCore-mbed Pull Requests](https://github.com/arduino/ArduinoCore-mbed/pulls)        |     $1000 USD          |
