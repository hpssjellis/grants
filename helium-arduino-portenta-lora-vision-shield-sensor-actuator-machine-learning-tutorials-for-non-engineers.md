...
| --- | --- | --- | --- |
|  MS#1 March 2021 - May 2021| Research Arduino Portenta Pro Dual Core 160 pin microcontroller |     Done    [Generic Portenta Github](https://github.com/hpssjellis/my-examples-for-the-arduino-portentaH7)       |     $500 USD         |
|  MS#2 March 2021 - May 2021| Research LoRa and LoRaWan abilities for the Arduino Portenta Pro LoRa Vision Shield, using the Murata Module and the [GrumpyOldPizza](https://github.com/GrumpyOldPizza/ArduinoCore-stm32l0) Library |     Done    [Portenta Murata Module LoRa Control](https://github.com/hpssjellis/portenta-lora-murata-stm32lo)       |     $500 USD         |
|  MS#3 March 2021 - May 2021| Research LoRa and LoRaWan abilities for the Arduino Portenta Pro LoRa Vision Shield, using the [MKRWAN](https://github.com/arduino-libraries/MKRWAN) Arduino Library |     Done  [MKRWAN Relevant Issues](https://github.com/arduino-libraries/MKRWAN/issues?q=is%3Aissue+portenta)        |     $500 USD         |
